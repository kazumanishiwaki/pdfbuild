...
class PostProcess {
    ...
    async metadata(tree, { pageProgression, browserVersion, viewerCoreVersion, disableCreatorOption, } = {}) {
        ...
        let creatorOpt = `Vivliostyle.js ${viewerCoreVersion !== null && viewerCoreVersion !== void 0 ? viewerCoreVersion : const_1.coreVersion}`;
        if (browserVersion) {
        ...
        if (pageProgression === 'rtl') {
            ...
            viewerPrefs.setReadingDirection(pdf_lib_1.ReadingDirection.R2L);
        }
    }
    async toc(items) {
