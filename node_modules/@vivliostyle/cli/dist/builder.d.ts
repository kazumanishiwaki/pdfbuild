...
export declare function compile({ entryContextDir, workspaceDir, manifestPath, manifestAutoGenerate, themeIndexes, entries, language, readingProgression, cover, vfmOptions, input, }: MergedConfig & WebPublicationManifestConfig, { reload }?: {
    reload?: boolean;
}): Promise<void>;
