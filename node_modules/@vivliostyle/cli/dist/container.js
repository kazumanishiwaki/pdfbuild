...
exports.runContainer = exports.collectVolumeArgs = exports.toContainerPath = exports.CONTAINER_ROOT_DIR = exports.CONTAINER_IMAGE = void 0;
...
function collectVolumeArgs(mountPoints) {
    return mountPoints
        ...
        let parent = p;
        while (!util_1.pathEquals(parent, upath_1.default.dirname(parent))) {
...
async function runContainer({ image, userVolumeArgs, commandArgs, entrypoint, }) {
    ...
    util_1.stopLogging('Launching docker container', '📦');
    const args = [
        'run',
