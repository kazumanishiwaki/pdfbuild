<?php
/**
 * Template Name: PDF Booklet: ⑦ 見出し＋左本文＋右画像キャプション×5（中2小3）
 * Description: 見出し、左カラム本文、右カラム画像キャプション5つ（中2小3）を含むPDFブックレットテンプレート
 */

// テンプレートファイルとして機能するための基本構造
get_header(); ?>

<div class="pdf-booklet-template template-heading-text-image-5-medium-small">
    <div class="container">
                    ...
                    <?php if (function_exists('get_field')): ?>
                        ...
                        <div class="pdf-two-columns">
                            ...
                            <div class="pdf-right-column">
                                <div class="pdf-image-grid pdf-image-grid-5-medium-small">
