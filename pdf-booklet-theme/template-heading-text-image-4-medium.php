<?php
/**
 * Template Name: PDF Booklet: ⑥ 見出し＋左本文＋右画像キャプション×4（中4）
 * Description: 見出し、左カラム本文、右カラム画像キャプション4つ（中4）を含むPDFブックレットテンプレート
 */

// テンプレートファイルとして機能するための基本構造
get_header(); ?>

<div class="pdf-booklet-template template-heading-text-image-4-medium">
    <div class="container">
            ...
            <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                ...
                <div class="entry-content">
                    <?php if (function_exists('get_field')): ?>
                        ...
                        $image_medium_3 = get_field('image_medium_3');
                        $caption_medium_3 = get_field('caption_medium_3');
                        $image_medium_4 = get_field('image_medium_4');
                        $caption_medium_4 = get_field('caption_medium_4');
                        ?>
                        ...
                        <div class="pdf-two-columns">
                            ...
                            <div class="pdf-right-column">
                                <div class="pdf-image-grid pdf-image-grid-4-medium">
                                    ...
                                    <?php if ($image_medium_3): ?>
                                        <div class="pdf-image-block pdf-image-medium">
                                            <img src="<?php echo esc_url($image_medium_3['url']); ?>" 
                                                 alt="<?php echo esc_attr($image_medium_3['alt']); ?>" 
                                                 class="pdf-image" />
                                            <?php if ($caption_medium_3): ?>
                                                <div class="pdf-caption">
                                                    <?php echo wp_kses_post(nl2br($caption_medium_3)); ?>
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                    <?php endif; ?>
                                    
                                    <?php if ($image_medium_4): ?>
                                        <div class="pdf-image-block pdf-image-medium">
                                            <img src="<?php echo esc_url($image_medium_4['url']); ?>" 
                                                 alt="<?php echo esc_attr($image_medium_4['alt']); ?>" 
                                                 class="pdf-image" />
                                            <?php if ($caption_medium_4): ?>
                                                <div class="pdf-caption">
                                                    <?php echo wp_kses_post(nl2br($caption_medium_4)); ?>
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                    <?php endif; ?>
